...
import { Sparkles, Users, Wand2, ArrowLeft } from 'lucide-react';
...
export function CardBattleLobby() {
  ...
  const handleCreateParty = async () => {
    ...
    try {
      console.log('🔍 Starting party creation for:', name);
      ...
      console.log('🔍 Calling createParty with:', {
      ...
      navigate(`/games/card-battle/game/${partyId}`);
    } catch (err) {
      console.error('❌ CardBattleLobby.tsx --> Error creating party:', err);
