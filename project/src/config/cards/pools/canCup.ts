...
export const CAN_CUP_CARDS: CardBase[] = [
...

  {
    id: 'cc-holy-alliance',
    name: 'Helig Allians',
    description: 'Politik lönar sig! Du skålar med målet. Ni båda får 2 Vattensklunkar var.',
    manaCost: 1,
    sipCost: 1,
    rarity: CardRarity.RARE,
    type: 'targeted',
  ...
  },
  {
    id: 'cc-rock-bottom',
    name: 'Botten Är Nådd',
    description: 'Din onykterhet ger dig styrka. Målet tar 1 klunk + 2 extra klunkar för varje Tom Burk du har!',
    manaCost: 1,
    sipCost: 1,
    rarity: CardRarity.RARE,
    type: 'targeted',
  ...
  },
  {
    id: 'cc-penalty-drink',
    name: 'Straffskål',
    description: 'Alla tar lika många klunkar som de har tomma burkar.',
    manaCost: 2,
    sipCost: 2,
    rarity: CardRarity.RARE,
    type: 'aoe',
  ...
  },
  {
    ...
    description: 'RISK: Väljer en SLUMPAD motståndare. Har de en legendary stjäl du en slumpad legendary och ersätter den med ett common. Har de ingen legendary dricker DU 6 straffklunkar.',
    manaCost: 2,
    sipCost: 2,
    rarity: CardRarity.EPIC,
    type: 'auto-targeted',
  ...
  },
  {
    ...
    name: 'Sten, Sax, Påse',
    description: 'Välj en motståndare för en klassisk Sten-Sax-Påse duell (Bäst av 3). Förloraren måste dricka 4 klunkar.',
    manaCost: 2,
    sipCost: 2,
    rarity: CardRarity.EPIC,
    type: 'challenge',
  ...
  },
  {
    ...
    name: 'Rysk Roulette',
    description: 'Flaskan snurras... En helt slumpmässig spelare vid bordet tvingas botten-uppa 1 hel burk. Ingen pardon.',
    manaCost: 3,
    sipCost: 3,
    rarity: CardRarity.EPIC,
    type: 'auto-targeted',
