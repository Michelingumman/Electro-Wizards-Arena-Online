...
export const ORIGINAL_EPIC_CARDS: CardBase[] = [
  {
    id: 'beer-havf',
    name: 'Öl Hävf',
  ...
  },
  {
    ...
    description: "Challenge the person to your LEFT then swap seats: Pushup contest to restore all Mana, Loser loses 5 Mana",
    manaCost: 5.0,
    rarity: CardRarity.EPIC,
    type: 'challenge',
    effect: {
